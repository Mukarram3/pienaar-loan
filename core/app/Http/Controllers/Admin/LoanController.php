...
// =============================================================
// File: app/Http/Controllers/Admin/LoanController.php
// =============================================================
...
class LoanController extends Controller
{
    ...
    /**
     * Generate the Commercial Loan Agreement.
     *
     * Delegates to LoanAgreementGenerator, which is now the single renderer for
     * this document (spec s.20). Signature kept so existing callers are
     * unchanged. Output for standard loans is unchanged.
     */
