                                ...
                                <div id="c-{{ $loop->iteration }}" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body">
                                        <ul class="caption-list">
                                            <li>
                                                <span class="caption">@lang('Instalment Amount')</span>
                                                <div class="value">
                                            ...
                                            <li>
                                                <span class="caption">@lang('Next Instalment')</span>
                                                <div class="value">
                                            ...
                                            <li>
                                                ...
                                                <div class="value">
                                                    <a class="btn btn--outline-primary btn--sm @disabled(!$loan->nextInstallment)"
                                                        ...
                                                        <i class="las la-wallet"></i> @lang('Instalments')
                                                    </a>
                                                </div>
                                            </li>
                                        </ul>
