                                        ...
                                        <div class="plan-card__body text-center">
                                            <ul class="plan-feature-list">
                                                <li class="plan-feature-list-item">
                                                    <span class="plan-feature-list-title">@lang('Minimum Amount')</span>
                                                    <span
                                                        class="plan-feature-list-amount ">{{ showAmount($plan->minimum_amount) }}</span>
                                                </li>
                                                <li class="plan-feature-list-item">
                                                    <span class="plan-feature-list-title">@lang('Maximum Amount')</span>
                                                    <span
                                                        class="plan-feature-list-amount ">{{ showAmount($plan->maximum_amount) }}</span>
                                                </li>
                                                <li class="plan-feature-list-item">
                                                    <span class="plan-feature-list-title">@lang('Instalment Interest Rate')</span>
                                                    <span
                                                        class="plan-feature-list-amount">{{ getAmount($plan->per_installment) }}%</span>
                                                </li>
                                                <li class="plan-feature-list-item">
                                                    <span class="plan-feature-list-title">@lang('Instalment Interval')</span>
                                                    <span class="plan-feature-list-amount">
                                                        {{ $plan->installment_interval }}
                                                        @lang('Days')</span>
                                                </li>
                                                <li class="plan-feature-list-item">
                                                    <span class="plan-feature-list-title"> @lang('Total Number of Instalments')</span>
                                                    <span
