...
<div class="info-line"><span class="label">Requested Loan Amount:</span> R{{amount}}</div>
...
<div class="info-line"><span class="label">Instalment Amount:</span> R{{per_installment}}</div>
<div class="info-line"><span class="label">Profit / Interest %:</span> {{profit_percentage}}%</div>
<div class="info-line"><span class="label">Application Fixed Charge:</span> R{{application_fixed_charge}}</div>
...
<div class="info-line"><span class="label">Fixed Late Fee:</span> R{{fixed_charge}}</div>
